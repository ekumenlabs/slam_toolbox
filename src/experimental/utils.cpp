...
void utils::grid_operations::updateCellLimits(std::vector<kt_double>& initial_x, std::vector<kt_double>& initial_y, std::vector<kt_double>& final_x, 
...
int utils::grid_operations::signum(int num)
{
    /*
...
std::pair<std::vector<int>, std::vector<int>> utils::grid_operations::rayCasting(
...
karto::Vector2<int> utils::grid_operations::getGridPosition(karto::Vector2<kt_double> const& pose, kt_double resolution)
{
...
std::vector<kt_double> utils::grid_operations::calculateCellIntersectionPoints(karto::Vector2<kt_double> const & laser_start, 
...
std::pair<std::vector<kt_double>, std::vector<kt_double>> utils::grid_operations::computeLineBoxIntersection(
...
template<typename T>
void utils::grid_operations::initializeGrid(std::vector<std::vector<T>> & grid, int num_rows, int num_columns)
{
    /*
        To create the grid
    */
